...
class Face_Register:
    def __init__(self):
        ...
        self.current_frame_faces_cnt = 0  #   for counting faces in current frame
        self.existing_faces_cnt = 0  #  for counting saved faces
        self.ss_cnt = 0  #   for screen shots

        # Tkinter GUI
        self.win = tk.Tk()
        self.win.title("Rajshtan Police ")
        ...
        # self.cap = cv2.VideoCapture("test.mp4")   # Agar hame kisi video me try karna hai
